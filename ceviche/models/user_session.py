...
class UserSession(db.Model):
    ...
    role = db.Column(db.String(50), nullable=False)  # Rol de usuario (admin, mozo, cocina, etc.)
    device_id = db.Column(db.String(100))  # Opcional: ID único del dispositivo
    # Timestamps
    ...
    def __init__(self, user_id,role ,device_id, device_info=None, ip_address=None, duration_hours=8):
        """
