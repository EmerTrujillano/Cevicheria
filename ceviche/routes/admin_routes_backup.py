...
def get_dashboard_stats():
    ...
    try:
        ...
        mesas_ocupadas = Table.query.filter_by(is_occupied=True).count()
        
        # Contar sesiones activas
        sesiones_activas = UserSession.query.filter_by(is_active=True).count()
        
        # Contar pedidos pendientes (en preparación)
        pedidos_pendientes = Order.query.filter_by(status='en_preparacion').count()
        
        # Calcular ventas del día (mock data por ahora)
        ventas_hoy = 0  # Implementar cálculo real después
    ...
    try:
        ...
        for categoria in categorias:
            ...
            categoria_data = {
                ...
                'station': categoria.estacion,  # Corregido campo
    ...
    try:
        ...
        for producto, category_name in productos:
            producto_data = {
                ...
                'available': producto.is_available,  # Corregido campo
